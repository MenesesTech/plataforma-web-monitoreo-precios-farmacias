    ...
    async with async_playwright() as p:
        ...
        if(html):
            ...
            for item in cards:
                ...
                precio_normal_content = precios_content_tag.find('fp-product-regular-price-mifa')
                ...
                precio_app_content = precios_content_tag.find('fp-product-price-mifa')
                if precio_app_content:
                    precio_app_tag = precio_app_content.find('span', class_='label')
                ...
                precio_tarjeta_content = precios_content_tag.find('fp-product-offer-price-mifa')
                if precio_tarjeta_content:
                    precio_tarjeta_tag = precio_tarjeta_content.find('span', class_='label')
